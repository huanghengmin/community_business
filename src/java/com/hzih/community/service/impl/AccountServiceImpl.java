package com.hzih.community.service.impl;

import cn.collin.commons.domain.PageResult;
import com.hzih.community.dao.AccountDao;
import com.hzih.community.dao.RoleDao;
import com.hzih.community.domain.Account;
import com.hzih.community.domain.Role;
import com.hzih.community.service.AccountService;
...
public class AccountServiceImpl implements AccountService {
     ...
     * @return
     */
    public String select(String userName, int userType,String status,int start,int limit) {
        PageResult pageResult = accountDao.listByPage(userName,userType,status,start/limit+1,limit);
