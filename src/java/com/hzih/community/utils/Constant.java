...
public class Constant {
    ...
    public final static String S_INTERNAL_PATH = StringContext.systemPath + "/repository/config.xml";
    public final static String S_EXTERNAL_PATH =  StringContext.systemPath + "/repository/external/config.xml";
